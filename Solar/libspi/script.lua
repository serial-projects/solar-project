...
local module = {}
module.basicsysc=require("Solar.libspi.basicsysc")
module.instance =require("Solar.libspi.instance")
module.text     =require("Solar.libspi.text")
module.consts   =require("Solar.libspi.consts")
