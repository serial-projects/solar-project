...
local module = {
    ...
    draw_using          = ETable.struct(1, {"COLOR", "TEXTURE", "SPRITES", "IMAGES"}),
    engine_modes        = ETable.struct(1, {"MENU", "WORLD", "CREDITS"}),
    player_directions   = ETable.struct(1, {"UP","DOWN","LEFT","RIGHT"}),
